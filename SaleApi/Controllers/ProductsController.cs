...
namespace SaleApi.Controllers
{
    ...
    public class ProductsController : BaseController<Product, ProductEx, ListModel<ProductEx>, InputProduct>
    {
	  ...
	  .Select(g => new ListSanPham
	  {
		  ...
		  Price1Count = g.Count(p => p.ProductPrice >= 0 && p.ProductPrice <= 1000000),
		  Price2Count = g.Count(p => p.ProductPrice > 1000000 && p.ProductPrice <= 10000000),
		  Price3Count = g.Count(p => p.ProductPrice > 10000000 && p.ProductPrice <= 50000000)
	  })
